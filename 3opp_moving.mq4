...
double calculateVolume(int pos,double stopLossDiff)

{
   ...
   double volume = 0.00 ;
   double stopLossVal = stopLossDiff * volume * lotSize;
   while(stopLossVal < lossValue)
   {
      volume = volume + 0.01;
      stopLossVal = stopLossDiff * volume * lotSize;
   }
...

{
...

   {
    ...
    double volume = calculateVolume(1,averageMove);
...

{
   ...
   double volume = calculateVolume(pos,calculateMoveOfStopLoss(pos) );
...

{
  ...
  double averageMove = valSpread * MultiplySpread;
   ...
   averageMove = calcOfLossValue(lossValue,pos);
...
//--- create timer
   ...
   double volume = calculateVolume(0,averageMove);
